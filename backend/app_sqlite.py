"""
NEXUS Backend — Flask Entry Point (with SQLite Auth)
"""
import os
...
from models_sqlite import User, init_db
...
def health():
    return jsonify({"status": "ok", "service": "NEXUS Backend", "version": "1.0.1", "database": "SQLite"})
...
if __name__ == "__main__":
    ...
    print(f"  ✓ Using SQLite database (no MSSQL required)\n")
